...
```sh
kpackagetool6 --type Plasma/Applet --install codexbar-plasmoid-v0.1.10-plasma6.plasmoid
# or upgrade:
kpackagetool6 --type Plasma/Applet --upgrade codexbar-plasmoid-v0.1.10-plasma6.plasmoid
```
