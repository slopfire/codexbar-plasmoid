...
providers, or all providers, and can be tinted by provider color, remaining-limit gradient (white→yellow→red), pace to reset (green when the budget comfortably outlasts the window, yellow when tight, red when CodexBar projects it runs dry before reset), or theme text color.
